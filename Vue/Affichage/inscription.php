    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
                <img src="https://cdn.pixabay.com/photo/2018/12/27/13/24/griffith-observatory-3897616_960_720.jpg" class="img-fluid" alt="Sample image" id="log_img">
            </div>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form action="index.php?module=ModInscription&action=inscription" method="POST">

                    <!-- Prenom -->
                    <div class="form-outline mb-4" id="prenomInscription">
