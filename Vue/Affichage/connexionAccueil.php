<section class="vh-100 form_log">
    ...
    <div class="container" id="buttonConnexionAccueil">
        ...
        <a class="btn btn-warning btn-lg" id="buttonVendeur" href="index.php?module=ModConnexion&action=formulaireVendeur" role="button" aria-disabled="true">Vendeur</a>
        <a class="btn btn-danger btn-lg" href="index.php?module=ModConnexion&action=formulaireAdmin" role="button" aria-disabled="true">Administrateur</a>
    </div>
</section>
